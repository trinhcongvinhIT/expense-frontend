...
function App() {
  ...
  const [fpConfirmPassword, setFpConfirmPassword] = useState(''); // 🔥 THÊM CHO QUÊN MẬT KHẨU

  // 🔥 STATE CHO NÚT "MẮT" HIỂN THỊ MẬT KHẨU 🔥
  const [showPassword, setShowPassword] = useState(false);       // Cho Login
  const [showRegPassword, setShowRegPassword] = useState(false); // Cho Register
  const [showFpPassword, setShowFpPassword] = useState(false);   // Cho Quên mật khẩu
  const [showConfirmPassword, setShowConfirmPassword] = useState(false); // Cho Nhập lại mật khẩu Đăng ký
  const [showFpConfirmPassword, setShowFpConfirmPassword] = useState(false); // 🔥 Cho Nhập lại mật khẩu Quên mk
  ...
  const handleRegisterStep1 = async (e) => {
    ...
    // 🔥 KIỂM TRA MẬT KHẨU NHẬP LẠI Ở ĐĂNG KÝ
    if (password !== confirmPassword) {
      setMessage({ text: 'Mật khẩu nhập lại không khớp!', isError: true });
  ...
  const handleResetPassword = async (e) => {
    ...
    // 🔥 KIỂM TRA MẬT KHẨU NHẬP LẠI Ở QUÊN MẬT KHẨU
                ...
                {isForgotPasswordMode ? (
                  <>
                    ...
                    {fpStep === 3 && (
                      <form onSubmit={handleResetPassword} className="space-y-4">
                        {/* 🔥 THÊM MẮT CHO FORM QUÊN MẬT KHẨU */}
                        <div className="space-y-1">
                          <div className="relative w-full">
                            <input type={showFpPassword ? "text" : "password"} placeholder="Nhập Mật khẩu mới" minLength="6" className="w-full px-5 md:px-6 py-3 md:py-4 pr-12 md:pr-12 rounded-2xl bg-slate-50 border-none outline-none focus:ring-2 focus:ring-emerald-300 font-bold text-slate-800 placeholder-slate-400 transition-all border border-slate-100 hover:bg-slate-100/50 text-sm md:text-base" value={fpNewPassword} onChange={(e) => setFpNewPassword(e.target.value)} required />
                            <button type="button" onClick={() => setShowFpPassword(!showFpPassword)} className="absolute right-4 top-1/2 transform -translate-y-1/2 text-slate-400 hover:text-emerald-500 transition-colors focus:outline-none">
                              {showFpPassword ? (
                        ...
                        {/* 🔥 THÊM MẮT CHO NHẬP LẠI MẬT KHẨU (QUÊN MK) */}
                        <div className="space-y-1">
                          <div className="relative w-full">
                            <input type={showFpConfirmPassword ? "text" : "password"} placeholder="Nhập lại mật khẩu mới" minLength="6" className="w-full px-5 md:px-6 py-3 md:py-4 pr-12 md:pr-12 rounded-2xl bg-slate-50 border-none outline-none focus:ring-2 focus:ring-emerald-300 font-bold text-slate-800 placeholder-slate-400 transition-all border border-slate-100 hover:bg-slate-100/50 text-sm md:text-base" value={fpConfirmPassword} onChange={(e) => setFpConfirmPassword(e.target.value)} required />
                            <button type="button" onClick={() => setShowFpConfirmPassword(!showFpConfirmPassword)} className="absolute right-4 top-1/2 transform -translate-y-1/2 text-slate-400 hover:text-emerald-500 transition-colors focus:outline-none">
                  ...
                  <>
                    {regStep === 1 && (
                      <form onSubmit={handleRegisterStep1} className="space-y-3 md:space-y-4">
                        ...
                        <div className="space-y-1">
                          {/* 🔥 Ô NHẬP MẬT KHẨU ĐĂNG KÝ */}
                          <div className="relative w-full">
                            <input type={showRegPassword ? "text" : "password"} placeholder="Mật khẩu" minLength="6" className="w-full px-5 md:px-6 py-3 md:py-4 pr-12 md:pr-12 rounded-2xl bg-slate-50 border-none outline-none focus:ring-2 focus:ring-teal-300 font-bold text-slate-800 placeholder-slate-400 transition-all border border-slate-100 hover:bg-slate-100/50 text-sm md:text-base" value={password} onChange={(e) => setPassword(e.target.value)} required />
                            <button type="button" onClick={() => setShowRegPassword(!showRegPassword)} className="absolute right-4 top-1/2 transform -translate-y-1/2 text-slate-400 hover:text-teal-500 transition-colors focus:outline-none">
                              {showRegPassword ? (
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5"><path strokeLinecap="round" strokeLinejoin="round" d="M3.98 8.223A10.477 10.477 0 001.934 12C3.226 16.338 7.244 19.5 12 19.5c.993 0 1.953-.138 2.863-.395M6.228 6.228A10.45 10.45 0 0112 4.5c4.756 0 8.773 3.162 10.065 7.498a10.523 10.523 0 01-4.293 5.774M6.228 6.228L3 3m3.228 3.228l3.65 3.65m7.894 7.894L21 21m-3.228-3.228l-3.65-3.65m0 0a3 3 0 10-4.243-4.243m4.242 4.242L9.88 9.88" /></svg>
                              ) : (
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5"><path strokeLinecap="round" strokeLinejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z" /><path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                        ...
                        <div className="space-y-1">
                          ...
                          <div className="relative w-full">
                            <input type={showConfirmPassword ? "text" : "password"} placeholder="Nhập lại mật khẩu" minLength="6" className="w-full px-5 md:px-6 py-3 md:py-4 pr-12 md:pr-12 rounded-2xl bg-slate-50 border-none outline-none focus:ring-2 focus:ring-teal-300 font-bold text-slate-800 placeholder-slate-400 transition-all border border-slate-100 hover:bg-slate-100/50 text-sm md:text-base" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} required />
                            <button type="button" onClick={() => setShowConfirmPassword(!showConfirmPassword)} className="absolute right-4 top-1/2 transform -translate-y-1/2 text-slate-400 hover:text-teal-500 transition-colors focus:outline-none">
                              {showConfirmPassword ? (
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5"><path strokeLinecap="round" strokeLinejoin="round" d="M3.98 8.223A10.477 10.477 0 001.934 12C3.226 16.338 7.244 19.5 12 19.5c.993 0 1.953-.138 2.863-.395M6.228 6.228A10.45 10.45 0 0112 4.5c4.756 0 8.773 3.162 10.065 7.498a10.523 10.523 0 01-4.293 5.774M6.228 6.228L3 3m3.228 3.228l3.65 3.65m7.894 7.894L21 21m-3.228-3.228l-3.65-3.65m0 0a3 3 0 10-4.243-4.243m4.242 4.242L9.88 9.88" /></svg>
                              ) : (
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5"><path strokeLinecap="round" strokeLinejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z" /><path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                  ...
                  <>
                    <form onSubmit={handleLogin} className="space-y-3 md:space-y-4">
                      ...
                      <div className="space-y-1">
                        {/* 🔥 THÊM MẮT CHO FORM ĐĂNG NHẬP */}
                        <div className="relative w-full">
                          <input type={showPassword ? "text" : "password"} placeholder="Mật khẩu" className="w-full px-5 md:px-6 py-3 md:py-4 pr-12 md:pr-12 rounded-2xl bg-slate-50 border-none outline-none focus:ring-2 focus:ring-teal-300 font-bold text-slate-800 placeholder-slate-400 transition-all border border-slate-100 hover:bg-slate-100/50 text-sm md:text-base" value={password} onChange={(e) => setPassword(e.target.value)} required />
                          <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute right-4 top-1/2 transform -translate-y-1/2 text-slate-400 hover:text-teal-500 transition-colors focus:outline-none">
                            {showPassword ? (
                              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5"><path strokeLinecap="round" strokeLinejoin="round" d="M3.98 8.223A10.477 10.477 0 001.934 12C3.226 16.338 7.244 19.5 12 19.5c.993 0 1.953-.138 2.863-.395M6.228 6.228A10.45 10.45 0 0112 4.5c4.756 0 8.773 3.162 10.065 7.498a10.523 10.523 0 01-4.293 5.774M6.228 6.228L3 3m3.228 3.228l3.65 3.65m7.894 7.894L21 21m-3.228-3.228l-3.65-3.65m0 0a3 3 0 10-4.243-4.243m4.242 4.242L9.88 9.88" /></svg>
                            ) : (
                              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5"><path strokeLinecap="round" strokeLinejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z" /><path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
